...
public class App {
    ...
    public App() {
        ...
        if (os.contains("linux")) {
            ...
            System.out.println("");
            System.out.println("If you are unable to figure out the error then just send the error message or the error pic to 'zerotheorymrt@gmail.com' or send us the problem in our Discord server, Have a Nice Day!");
            System.out.println("");
            ...
            settingsButton.addActionListener(e -> {
                ...
                JButton reportbug = new JButton("Report a bug");
                reportbug.setBounds(10, 160, 200, 20);
                reportbug.addActionListener(e1 -> {
                    try {
                    Desktop.getDesktop().browse(new java.net.URI("https://github.com/AlphaWolf6940/Optomizer/issues"));
                }   catch (Exception ex) {
                        ex.printStackTrace();
                }
                });
                generalTab.add(reportbug);
            ...
            System.out.println("Target is Linux OS detected os: " + os);
            System.out.println("");
            System.out.println("WARNING: Target not reached..." + os + "is supported by the app..." + "Successfully Starting...");
            System.out.println("");
            System.out.println("Any ongoing background processes will be displayed on the terminal");
            System.out.println("");
            System.out.println("If you feel there are any errors, please check the terminal for error messages");
            ...
            pidButton.addActionListener(e -> {
                ...
                try {
                    ...
                    String command = "wmic process where ProcessId=" + pidText + " CALL setpriority 128"; // 128 is 'High' in Windows
            ...
            settingsButton.addActionListener(e -> {
                ...
                JLabel creditsLabel = new JLabel("Credits: Thanks to AlphaWolf6940 for all the coding & Idea by JoeDuck2020!");
                //JLabel creditsLabel1 = new JLabel("Credits to JoeDuck2020 for the Idea");
                creditsLabel.setBounds(10, 40, 355, 20);
                creditsTab.add(creditsLabel);
                //creditsTab.add(creditsLabel1);
